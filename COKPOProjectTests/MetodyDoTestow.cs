...
namespace COKPOProjectTests
{
    public static class MetodyDoTestow
    {
        public static CentrumTransakcji StworzTestoweDane()
        {
            ...
            centrumTransakcji.Banki[0].Klienci.Add(new ZwyklyKlient("Jan Kowalski", centrumTransakcji.Banki[0]));
            ...
            centrumTransakcji.Banki[0].Klienci.Add(new Firma("Mlekpol", centrumTransakcji.Banki[0]));
            centrumTransakcji.Banki[0].Klienci[1].DodajKarte(1, 13000, "");
            centrumTransakcji.Banki[0].Klienci[1].DodajKarte(0, 50, "");
            centrumTransakcji.Banki[1].Klienci.Add(new ZwyklyKlient("Leon Bober", centrumTransakcji.Banki[1]));
            centrumTransakcji.Banki[1].Klienci[0].DodajKarte(0, 69, "");
            centrumTransakcji.Banki[1].Klienci[0].DodajKarte(1, 6969, "");
            centrumTransakcji.Banki[1].Klienci.Add(new Firma("Adidasz", centrumTransakcji.Banki[1]));
